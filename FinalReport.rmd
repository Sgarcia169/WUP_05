...
The response variable is categorical based on the treatment of the new aids drug and the explanatory variable is categorical treatment. Therefore we utilize the numerical~cat.
